...
fit2 <- arima(ts_data_chicken[,"calls"], xreg = ts_data_chicken[,covariate], order = c(3,1,3),
              seasonal = list(order=c(0,0,2), period =7))
fit3 <- arima(ts_data_chicken[,"calls"], xreg = ts_data_chicken[,covariate], order = c(1,0,1),
              seasonal = list(order=c(0,0,2), period =7))
fit4 <- arima(ts_data_chicken[,"calls"], xreg = ts_data_chicken[,covariate], order = c(3,1,3),
...
fit2 <- arima(ts_data_chinese[,"calls"], xreg = ts_data_chinese[,covariate], order = c(2,1,2),
              seasonal = list(order=c(2,0,2), period =7))
fit3 <- arima(ts_data_chinese[,"calls"], xreg = ts_data_chinese[,covariate], order = c(0,0,1),
              seasonal = list(order=c(2,0,2), period =7))
fit4 <- arima(ts_data_chinese[,"calls"], xreg = ts_data_chinese[,covariate], order = c(2,1,2),
              seasonal = list(order=c(1,0,2), period =7))
